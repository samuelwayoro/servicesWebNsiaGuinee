...
@XmlType(name = "TNAEFACTUREMAINType", namespace = "http://temenos.com/TNAEFACTUREMAIN", propOrder = {
    "gtnaefacturemainDetailType"
})
public class TNAEFACTUREMAINType {

    @XmlElement(name = "gTNAEFACTUREMAINDetailType", namespace = "http://temenos.com/TNAEFACTUREMAIN")
    ...
    public static class GTNAEFACTUREMAINDetailType {
        ...
        @XmlElement(name = "mTNAEFACTUREMAINDetailType", namespace = "http://temenos.com/TNAEFACTUREMAIN")
        ...
        public static class MTNAEFACTUREMAINDetailType {
            ...
            @XmlElement(name = "REQUETE", namespace = "http://temenos.com/TNAEFACTUREMAIN")
            protected String requete;
            @XmlElement(name = "REPONSEEFACTURE", namespace = "http://temenos.com/TNAEFACTUREMAIN")
